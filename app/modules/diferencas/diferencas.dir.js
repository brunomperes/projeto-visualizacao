...
angular.module('projetobrasil.dados.diferencas.directives', [])
  .directive('barraDiferencas', [function() {
    return {
      restrict: 'E',
      replace: false,
      link: function (scope, element, attrs) {

      	var dados = JSON.parse(attrs.dadosDiferencas);

      	var margin = {top: 50, right: 10, bottom: 10, left: 10},
      	    width = $(element[0]).parent().width()-70,
